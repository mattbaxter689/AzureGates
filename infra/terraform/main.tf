...
# # -------------------------------
# # Compute Cluster
# # Identity MUST be defined at creation — not patched after
# # -------------------------------
...
#   }
#
#   # Identity attached at creation time — required for AcrPull and blob access at job runtime
#   identity {
#     type = "SystemAssigned"
#   }
#
...
# # Workspace identity needs secret access for AML operations
# # -------------------------------
# resource "azurerm_key_vault_access_policy" "workspace_kv_access" {
#   key_vault_id = azurerm_key_vault.kv.id
#   tenant_id    = data.azurerm_client_config.current.tenant_id
#   object_id    = azurerm_machine_learning_workspace.aml.identity[0].principal_id
#
...
# # -------------------------------
# # Role Assignments
# # Every identity used at runtime must be explicitly granted
# # permissions at the correct scope during provisioning
# # -------------------------------
#
# # Workspace — AcrPull (pulling images during job prep)
...
# }
#
# # Workspace — AcrPush (pushing built environments to ACR)
...
# }
#
# # Workspace — Storage Blob Data Contributor (reading/writing data assets)
...
# }
#
# # Compute — AcrPull (pulling images at job runtime)
